            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    if(names_array.contains(username)){
                        Toast.makeText(faculty.this, username, Toast.LENGTH_SHORT).show();
                    }
                ...
                arrayAdapter = new ArrayAdapter<String>(faculty.this, android.R.layout.simple_list_item_1, names_array );
